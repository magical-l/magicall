...
public final class MapKit extends WithSubclassKit<Map<?, ?>> {
	...
	//----------------------------------------------
	public <K, T, V> Map<K, V> transform(final Map<K, T> source, final Transformer<T, V> transformer) {
	...
	public <K, V> Map<K, V> fromCollection(final Collection<? extends V> source, final KeyAccessor<? extends K, ? super V> keyExtractor) {
