...
public class ListIndexElementMap<V> extends UnmodifiableMapTemplate<Integer, V>//
		implements Unmodifiable, Serializable, Map<Integer, V>, SortedMap<Integer, V> {
	...
	private class SeqEntrySet extends AbstractSet<Entry<Integer, V>> implements Set<Entry<Integer, V>>, Unmodifiable, Serializable {
	...
	private class SeqEntryIterator extends UnmodifiableIteratorTemplate<Entry<Integer, V>> implements Iterator<Entry<Integer, V>>, Unmodifiable, Serializable {
